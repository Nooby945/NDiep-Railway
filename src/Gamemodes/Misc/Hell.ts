 ...
 */
export default class HellArena extends ArenaEntity {
    ...
    public constructor(game: GameServer) {
        ...
        nimdac.styleData.color = Color.TeamBlue;
        nimdac.relationsData.values.team = new TeamEntity(this.game, Color.TeamBlue);
        nimdac.nameData.name = "[MG]Spin2Team";
    }
    ...
    public tick(tick: number) {
        ...
        if (this.nimdac && this.nimdac.inputs) {
            ...
            this.nimdac.inputs.mouse.angle += 0.4;
        }
        super.tick(tick);
    }
}