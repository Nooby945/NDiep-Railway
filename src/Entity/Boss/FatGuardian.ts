...
const GUARDIAN_SIZE = 270;

/**
 * Class which represents the boss "FatGuardian"
 */
export default class Guardian extends AbstractBoss {
    public constructor(game: GameServer) {
        super(game);

        this.nameData.values.name = 'Fatass Guardian';
        this.altName = 'Fatass Guardian of the Pentagons';
